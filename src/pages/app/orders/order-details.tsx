...
export function OrderDetails() {
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Pedido: 98af469a85s4c86asf</DialogTitle>
      ...
      <div className="space-y-6">
        <Table>
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell className="flex justify-end">
                Gabriel Valino Sanches
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell className="text-muted-foreground">Telefone</TableCell>
              <TableCell className="flex justify-end">(11) 940158431</TableCell>
            </TableRow>
            <TableRow>
        ...
        <Table>
          ...
          <TableBody>
            <TableRow>
              <TableCell>Pizza Abacaxi</TableCell>
